        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    <form method="post" action="{{ route('rates.store') }}" class="mt-6 space-y-6">
                        @csrf
                        @method('post')
                        ...
                        <div>
                            ...
                            <input type="text" id="type" name="type" step="0.00001" class="mt-1 block w-full" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="source" name="source" step="0.00001" class="mt-1 block w-full" required>
